...
export function createNotePageActions(rawContext: object) {
	...
	return {
		...
		openPreviewModal: ctx.linkingSession.openPreviewModal,
		handleVditorClick: ctx.linkingSession.handleVditorClick,
		handleVditorKeydownCapture: ctx.linkingSession.handleVditorKeydownCapture,
		handleVditorKeyupCapture: ctx.linkingSession.handleVditorKeyupCapture,
		handleLinkSearchKeydown: ctx.linkingSession.handleLinkSearchKeydown,
		autofocus: ctx.linkingSession.autofocus,
		selectNoteForBlocks: ctx.linkingSession.selectNoteForBlocks,
		insertBlockLink: ctx.linkingSession.insertBlockLink,
		openGlobalBlockSearch: ctx.linkingSession.openGlobalBlockSearch,
		handleGlobalSearchKeydown: ctx.linkingSession.handleGlobalSearchKeydown,
		insertGlobalBlockLink: ctx.linkingSession.insertGlobalBlockLink,
