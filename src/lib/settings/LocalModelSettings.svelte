...
<section id="settings-local-ai" class="settings-section">
	{#if showSection('settings-local-ai')}
		...
		{/if}
	{/if}
	{#if showSection('settings-web-search')}
		<br />
		<h2 id="settings-web-search">Web Search</h2>
		<p class="description">
	...
	{/if}
	{#if showSection('settings-embeddings')}
		<br />
		<h2 id="settings-embeddings">Embeddings — Document Search & RAG</h2>
		<p class="description">
	...
	{/if}
	{#if showSection('settings-reranker')}
		<br />
		<h2 id="settings-reranker">Reranker — Final Evidence Ordering</h2>
		<p class="description">
	...
	{/if}
	{#if showSection('settings-pdf-ocr')}
		<br />
		<h2 id="settings-pdf-ocr">PDF OCR</h2>
		<p class="description">
		...
		{/if}
	{/if}
	{#if showSection('settings-compatible-models')}
		{#if settings.modelProfiles.length > 0}
			<br />
			<h2 id="settings-compatible-models">Compatible Models</h2>
			<p class="description">
		...
		{/if}
	{/if}
	{#if showSection('settings-advanced-ai')}
		<br />
		<h2 id="settings-advanced-ai">Advanced AI Configuration</h2>
		<p class="description">
