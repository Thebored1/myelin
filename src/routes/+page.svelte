					...
					<div class="dash-left">
						<section class="dash-section nb-section">
							<h3 class="nb-header-tabs-container">
								...
								{/if}
								<div class="nb-add-wrap">
									<button class="nb-add-btn" onclick={(e) => { e.stopPropagation(); showAddMenu = !showAddMenu; }} disabled={isBusy} aria-label="Add" title="New note or upload">
										<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
									</button>
									{#if showAddMenu}
										<!-- svelte-ignore a11y_click_events_have_key_events a11y_no_static_element_interactions -->
										<div class="nb-add-menu" onclick={(e) => e.stopPropagation()}>
											<button class="nb-add-item" onclick={() => { createNote('md'); showAddMenu = false; }}><span class="plus">+</span> Markdown</button>
											<button class="nb-add-item" onclick={() => { createNote('tex'); showAddMenu = false; }}><span class="plus">+</span> LaTeX</button>
											<button class="nb-add-item" onclick={() => { createNote('ipynb'); showAddMenu = false; }}><span class="plus">+</span> Jupyter</button>
											<div class="nb-add-divider"></div>
											<button class="nb-add-item" onclick={importFile}>
