...
Write-Output "=== 1/3 merge LoRA -> out\merged ==="
& $venv train_lora.py --merge --base base\granite-4.0-h-1b --out out\adapter --merged out\merged
...
& $venv llama.cpp\convert_hf_to_gguf.py out\merged --outfile out\granite-myelin-f16.gguf --outtype f16
...
& $quant out\granite-myelin-f16.gguf out\granite-myelin-Q4_K_M.gguf Q4_K_M
